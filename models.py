...
class UserTypeModel(Base):
    ...
    user = relationship('UserModel', back_populates='user_types')
...
class UserModel(Base):
    ...
    user_type_id = Column(Integer, ForeignKey("user_types.id", ondelete="CASCADE"))
    ...
    user_types = relationship('UserTypeModel', back_populates='user')
